...
public class CodesA extends JDialog {
	...
	public CodesA(String t,String o,String r,Object  w){
		...
		reinit=new JButton("REINITIALESR");
		...
		envoyer.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				pane.showMessageDialog(null, "L'etudiant "+t +"  " +o+" de sexe "				
				+  w+" de  matricule  "+ r +" ayant compose les UEs "+" "
